...
<?php
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where status='1' and org_type like '$org_type'";
	...
	/* Get data. */
	$sql = "SELECT * FROM $tbl_name where status='1' and org_type like '$org_type' ORDER BY regristration_id DESC LIMIT $start, $limit";
