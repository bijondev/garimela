...
<? } ?>
    ...
    <td><select name="org_divition" id="org_divition" onChange="getdistict()" >
...
<?php
	...
	*/
	...
	/* Get data. */
	$sql = "SELECT * FROM $tbl_name where status='1' and org_type like '$org_type' and divition like '$org_divition' and dstict like '$org_district' and ps like '$org_ps' ORDER BY regristration_id DESC LIMIT $start, $limit";
