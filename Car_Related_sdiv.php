...
<div class="epage">
<div class="maincont2">
<div class="featureTop" style="color:OrangeRed;text-shadow: grey 0.1em 0.1em 0.3em;"><h3>YOUR DESIRED INFORMATION</h3></div>
...
<?php
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name  where status='1' and org_type like '$org_type' and divition like '$org_divition'";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "?action=search_Car_Related_Organization"; 	//your file name  (the name of this file)
	...
	/* Get data. */
	$sql = "SELECT * FROM $tbl_name where status='1' and org_type like '$org_type' and divition like '$org_divition' ORDER BY regristration_id DESC LIMIT $start, $limit";
...
<div align="center" style="color:#009EE0;text-shadow: grey 0.1em 0.1em 0.3em; font-size:12px; height:auto; width:260px; margin:0 auto; margin-top:2px;">E-mail : 
<?=$row['email']?>
