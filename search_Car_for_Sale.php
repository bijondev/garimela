...
<table height="50" width="700" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td style="color:OrangeRed;text-shadow: grey 0.1em 0.1em 0.3em;">Find Desired Car::</td>
    <td>
...
<?php
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where status='1' and car_type like '%$car_type%'";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "?action=search_Car_for_Sale"; 	//your file name  (the name of this file)
	...
	/* Get data. */
	$sql_car_for_sales = "SELECT * FROM $tbl_name where status='1' and car_type like '%$car_type%' ORDER BY  sell_id DESC  LIMIT $start, $limit";
	//echo $sql_car_for_sales;
...
<table width="100%" border="1" cellspacing="1" align="center" style="border-style:double; border-color:#DADBDC;">
  <tr>
 <td width="12%" align="center" class="festabe" style="background-color:#EBECED; color:OrangeRed;text-shadow: grey 0.1em 0.1em 0.3em;"><b>Car Picture</b></td>
    <td width="19%" align="center" class="festabe" style="background-color:#EBECED; color:OrangeRed;text-shadow: grey 0.1em 0.1em 0.3em;"><b>Car Name / Model</b></td>
    <td width="39%" align="center" class="festabe" style="background-color:#EBECED; color:OrangeRed;text-shadow: grey 0.1em 0.1em 0.3em;"><b>Car Description</b></td>
   
    <td width="15%" align="center" class="festabe" style="background-color:#EBECED; color:OrangeRed;text-shadow: grey 0.1em 0.1em 0.3em;"><b>Car Price</b></td>
    <td width="15%" align="center" class="festabe" style="background-color:#EBECED; color:OrangeRed;text-shadow: grey 0.1em 0.1em 0.3em;"><b>Contact</b></td>
  </tr>
	<?php
