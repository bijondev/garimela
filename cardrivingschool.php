...
<div class="epage">
<div class="maincont2">
<div class="featureTop" style="color:OrangeRed;text-shadow: grey 0.1em 0.1em 0.3em;"><h3>CAR DRIVING SCHOOL</h3></div>
...
<?php
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where status='1' AND org_type='14' ORDER BY  regristration_id DESC";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "?action=cardrivingschool"; 	//your file name  (the name of this file)
	...
	/* Get data. */
	$sql = "SELECT * FROM $tbl_name where status='1' AND org_type='14' ORDER BY  regristration_id DESC LIMIT $start, $limit";
