...
<table height="50" width="700" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td style="color:OrangeRed;text-shadow: grey 0.1em 0.1em 0.3em;">Find Desired Buyer::</td>
    <td>
...
<?php
	...
	$org_ps=$_POST['org_ps'];
	//echo $car_type.$org_divition.$org_district.$org_ps;
	/*
	...
	*/
	...
	/* Get data. */
	$sql_car_buy = "SELECT * FROM $tbl_name where status='1' and car_type like '%$car_type%' ORDER BY buyare_id DESC LIMIT $start, $limit";
	//echo $sql_car_buy;
...
<table width="100%" border="1" cellspacing="1" align="center" style="border-style:double; border-color:#DADBDC;">
  <tr>
    ...
    <td width="26%" align="center" class="festabe" style="background-color:#EBECED; color:OrangeRed;text-shadow: grey 0.1em 0.1em 0.3em;"><b>Car Description</b></td>
        <td width="15%" align="center" class="festabe" style="background-color:#EBECED; color:OrangeRed;text-shadow: grey 0.1em 0.1em 0.3em;"><b>Budget</b></td>
    <td width="18%" align="center" class="festabe" style="background-color:#EBECED; color:OrangeRed;text-shadow: grey 0.1em 0.1em 0.3em;"><b>Buyer Address</b></td>
        <td width="20%" align="center" class="festabe" style="background-color:#EBECED; color:OrangeRed;text-shadow: grey 0.1em 0.1em 0.3em;"><b>Buyer Contact</b></td>
