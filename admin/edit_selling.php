...
//echo $datetime;
mysql_query("UPDATE   tbl_sellinginfo SET  pub_date =  '$pub_date', end_date =  '$end_date', car_type =  '$car_type', car_model =  '$car_model', car_discription =  '$car_discription', car_price =  '$car_price', ad_duration =  '$ad_duration', contact_no =  '$contact_no', contact_address =  '$contact_address', update_by =  '$userid', update_by_date_time =  '$datetime', update_ip =  '$ip' WHERE  sell_id ='$sid'") or die (mysql_error());
}
...
<? } ?>
  ...
  <tr>
    <td>Car Price</td>
    <td>:</td>
    <td><input type="text" name="car_price" value="<?=$row['car_price']?>"></td>
  </tr>
  <tr>
    <td>Ad Duration</td>
    <td>:</td>
