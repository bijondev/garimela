...
<?php
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where status='1' and org_type like '$org_type' and divition like '$org_divition' and dstict like '$org_district'";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "?action=Car_Related_sdist"; 	//your file name  (the name of this file)
	...
	/* Get data. */
	$sql = "SELECT * FROM $tbl_name where status='1' and org_type like '$org_type' and divition like '$org_divition' and dstict like '$org_district' ORDER BY regristration_id DESC LIMIT $start, $limit";
